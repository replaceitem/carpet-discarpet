...
public class DiscordEvents {
    ...
    public static final BotEvents.Args3<MessageReaction, Member, Boolean> DISCORD_REACTION = new BotEvents.Args3<>("discord_reaction");
    ...
    public static final BotEvents.Args2<Guild,Member> DISCORD_SERVER_MEMBER_JOIN = new BotEvents.Args2<>("discord_server_member_join");
