...
import net.replaceitem.discarpet.mixins.AttachmentMixin;
...
public class AttachmentValue extends DiscordValue<Message.Attachment> {
    ...
    public Value getProperty(String property) {
        return switch (property) {
            case "message" -> MessageValue.of(getMessage());
    ...
    private Optional<Message> getMessage() {
        // TODO does this work?
        return Optional.of(((AttachmentMixin) delegate).getMessage());
//        try {
//            Field field = delegate.getClass().getField("this$0");
//            field.setAccessible(true);
//            return Optional.of((Message) field.get(delegate));
