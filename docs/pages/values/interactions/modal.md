...
|     `value` | String, List of Strings, Boolean, List of [Attachments](/values/attachment.md) | The value submitted by the user. The type depends on the component type:<br/>* Text input: String<br/>* Select menu: List of Strings<br/>* Checkbox group: List of Strings<br/>* Radio group: String<br/>* Checkbox: Boolean<br/>* File upload: List of Attachments |